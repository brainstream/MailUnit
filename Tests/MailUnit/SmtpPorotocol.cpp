...
BOOST_AUTO_TEST_CASE(simpleSequanceTest)
{
    ...
    BOOST_CHECK_EQUAL(0u, transport.read_count);
    BOOST_CHECK_EQUAL(0u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(0u, transport.exit_count);
    BOOST_CHECK(!transport.latest_response.is_initialized());

    protocol.start();
    transport.performNextAction();
    BOOST_CHECK_EQUAL(0u, transport.read_count);
    BOOST_CHECK_EQUAL(1u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(0u, transport.exit_count);
    BOOST_CHECK(transport.latest_response.is_initialized());
    BOOST_CHECK(ResponseCode::ready == transport.latest_response->code());
    transport.performNextAction();
    BOOST_CHECK_EQUAL(1u, transport.read_count);
    BOOST_CHECK_EQUAL(1u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(0u, transport.exit_count);
    ...
    transport.performNextAction();
    BOOST_CHECK_EQUAL(1u, transport.read_count);
    BOOST_CHECK_EQUAL(2u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(0u, transport.exit_count);
    BOOST_CHECK(ResponseCode::ok == transport.latest_response->code());
    transport.performNextAction();
    BOOST_CHECK_EQUAL(2u, transport.read_count);
    BOOST_CHECK_EQUAL(2u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(0u, transport.exit_count);
    ...
    transport.performNextAction();
    BOOST_CHECK_EQUAL(2u, transport.read_count);
    BOOST_CHECK_EQUAL(3u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(0u, transport.exit_count);
    BOOST_CHECK(ResponseCode::ok == transport.latest_response->code());
    transport.performNextAction();
    BOOST_CHECK_EQUAL(3u, transport.read_count);
    BOOST_CHECK_EQUAL(3u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(0u, transport.exit_count);
    ...
    transport.performNextAction();
    BOOST_CHECK_EQUAL(3u, transport.read_count);
    BOOST_CHECK_EQUAL(4u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(0u, transport.exit_count);
    BOOST_CHECK(ResponseCode::ok == transport.latest_response->code());
    transport.performNextAction();
    BOOST_CHECK_EQUAL(4u, transport.read_count);
    BOOST_CHECK_EQUAL(4u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(0u, transport.exit_count);
    ...
    transport.performNextAction();
    BOOST_CHECK_EQUAL(4u, transport.read_count);
    BOOST_CHECK_EQUAL(5u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(0u, transport.exit_count);
    BOOST_CHECK(ResponseCode::intermediate == transport.latest_response->code());
    transport.performNextAction();
    BOOST_CHECK_EQUAL(5u, transport.read_count);
    BOOST_CHECK_EQUAL(5u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(0u, transport.exit_count);
    ...
    transport.performNextAction();
    BOOST_CHECK_EQUAL(6u, transport.read_count);
    BOOST_CHECK_EQUAL(5u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(0u, transport.exit_count);
    ...
    transport.performNextAction();
    BOOST_CHECK_EQUAL(6u, transport.read_count);
    BOOST_CHECK_EQUAL(6u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(0u, transport.exit_count);
    BOOST_CHECK(ResponseCode::ok == transport.latest_response->code());
    transport.performNextAction();
    BOOST_CHECK_EQUAL(7u, transport.read_count);
    BOOST_CHECK_EQUAL(6u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(0u, transport.exit_count);
    ...
    transport.performNextAction();
    BOOST_CHECK_EQUAL(7u, transport.read_count);
    BOOST_CHECK_EQUAL(7u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(0u, transport.exit_count);
    ...
    BOOST_CHECK_EQUAL(7u, transport.write_count);
    BOOST_CHECK_EQUAL(0u, transport.switch_to_tls_count);
    BOOST_CHECK_EQUAL(1u, transport.exit_count);
}
...
BOOST_AUTO_TEST_CASE(startTlsTest)
{
    ...
    transport.performNextAction();
    transport.performNextAction();
    BOOST_CHECK_EQUAL(1u, transport.switch_to_tls_count);
}

...
BOOST_AUTO_TEST_CASE(parse)
{
    ...
    memset(&date_time, 0, sizeof(MU_DateTime));
    BOOST_CHECK_EQUAL(mu_true, muDateTimeParse(valid_raw_dow, &date_time));
    BOOST_CHECK_EQUAL(mu_dow_sat, date_time.day_of_week);
    BOOST_CHECK_EQUAL(12, date_time.day);
    BOOST_CHECK_EQUAL(mu_month_jul, date_time.month);
    ...
    memset(&date_time, 0, sizeof(MU_DateTime));
    BOOST_CHECK_EQUAL(mu_true, muDateTimeParse(valid_raw_dow_without_sec, &date_time));
    BOOST_CHECK_EQUAL(mu_dow_sat, date_time.day_of_week);
    BOOST_CHECK_EQUAL(12, date_time.day);
    BOOST_CHECK_EQUAL(mu_month_jul, date_time.month);
    BOOST_CHECK_EQUAL(2014, date_time.year);
    ...
    memset(&date_time, 0, sizeof(MU_DateTime));
    BOOST_CHECK_EQUAL(mu_true, muDateTimeParse(valid_raw_dow_without_dow, &date_time));
    BOOST_CHECK_EQUAL(mu_dow_invalid, date_time.day_of_week);
    BOOST_CHECK_EQUAL(12, date_time.day);
    BOOST_CHECK_EQUAL(mu_month_jul, date_time.month);
    BOOST_CHECK_EQUAL(2014, date_time.year);
    BOOST_CHECK_EQUAL(20, date_time.hours);
    ...
    BOOST_CHECK_EQUAL(mu_false, muDateTimeParse(valid_raw_dow, nullptr));
    BOOST_CHECK_EQUAL(mu_false, muDateTimeParse(invalid_raw_dow_1, &date_time));
    BOOST_CHECK_EQUAL(mu_false, muDateTimeParse(invalid_raw_dow_2, &date_time));
    BOOST_CHECK_EQUAL(mu_false, muDateTimeParse(invalid_raw_dow_3, &date_time));
    BOOST_CHECK_EQUAL(mu_false, muDateTimeParse(invalid_raw_dow_4, &date_time));
}
...
BOOST_AUTO_TEST_CASE(fromUnixTime)
{
    ...
    BOOST_CHECK_EQUAL(mu_month_jun, dt.month);
    BOOST_CHECK_EQUAL(1, dt.day);
    BOOST_CHECK_EQUAL(mu_dow_sun, dt.day_of_week);
